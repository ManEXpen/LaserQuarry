...
public enum EnumChatColor {
    ...
    public static EnumChatColor[] DYES = new EnumChatColor[]{BLACK, RED, DARK_GREEN, BROWN, DARK_BLUE, PURPLE, DARK_AQUA, GREY, DARK_GREY, BRIGHT_PINK, BRIGHT_GREEN, YELLOW, INDIGO, PINK, ORANGE, WHITE};
    ...
    private EnumChatColor(String s, String n, String dye, int[] rgb, int meta) {
        code = s;
        unlocalizedName = n;
        dyeName = dye;
        rgbCode = rgb;
